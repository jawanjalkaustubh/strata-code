...
### Addendum — free public release with voluntary donations (2026-09-12)

- `EULA.md` v1.1: free of charge for any lawful use; may share the unmodified official download; no selling or modified redistribution; new section 7 **Donations** (voluntary, a gift not a purchase, non-refundable except by law, processed by third-party platforms, not tax-deductible); "pre-release / tester" labelling removed at the user's request while the defects and no-warranty language stays. Because acceptance is keyed to the text hash, the new version was shown again on next launch - verified.
